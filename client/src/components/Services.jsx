    ...
    <div className="flex md:flex-row flex-col items-center justify-between md:p-10 px-4">
      ...
      <div className="flex-1 flex flex-col justify-start items-center">
        ...
        <ServiceCard
          ...
          subtitle="A flexible exchange rate is important & it shouldn't be depend on other individual"
        />
        <ServiceCard
          color="bg-[#F84550]"
          title="Fastest transactions"
          icon={<RiHeart2Fill fontSize={21} className="text-white" />}
          subtitle="We value you time that's why we are presenting you with the fastest transactions"
        />
      </div>
    </div>
  </div>
