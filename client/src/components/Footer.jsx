...
const Footer = () => (
  <div className="w-full flex md:justify-center justify-between items-center flex-col p-2 gradient-bg-footer">
    ...
    <div className="flex justify-center items-center flex-col p-0">
      ...
      <a href="https://www.linkedin.com/in/kartavya-panthi" target="_blank" className="text-white text-left text-4xl px-2" ><img src={linkedin} className="w-10 h-10 rounded-xl m-2"></img></a>
      <a href="https://github.com/Kartv07/krypto_world" target="_blank" className="text-white text-right text-4xl px-2" ><img src={git} className="w-10 h-10 rounded-xl "></img></a>
      </div>
    </div>
